package net.gralakel.learingmod;

import com.mojang.logging.LogUtils;
import net.gralakel.learingmod.block.ModBlocks;
import net.gralakel.learingmod.item.ModCreativeModeTabs;
...
public class LearningMod
{
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event){
        if(event.getTabKey() == CreativeModeTabs.INGREDIENTS) {
            event.accept(ModItems.LAPOFERRITE);
            event.accept(ModItems.INFUSEDLAPIS);
        }
    }
